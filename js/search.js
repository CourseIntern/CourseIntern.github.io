...
function clearSearchResults() {
  ...
  document.querySelector("#results-count-text").innerHTML = "";
}
...
function adjustHue(hue1, hue2, score) {
  //maintaining constant color for now
  return `hsl(178, 73%, 27%)`;
  // TODO: Adjust ranking logic and then uncomment this code
